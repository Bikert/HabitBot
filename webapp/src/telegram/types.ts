...
export interface CloudStorage {
  ...
  getItem: (key: CloudStorageKey, callback?: (error: string | null, result?: CloudStorageValue) => unknown) => void
  getItems: (
    keys: Array<CloudStorageKey>,
    callback?: (error: string | null, result?: CloudStorageItems) => unknown,
  ) => void
  getKeys: (callback?: (error: string | null, result?: Array<CloudStorageKey>) => unknown) => void
  removeItem: (key: CloudStorageKey, callback?: (error: string | null, result?: boolean) => unknown) => void
  removeItems: (key: Array<CloudStorageKey>, callback?: (error: string | null, result?: boolean) => unknown) => void
}
...
export type Platforms = 'android' | 'android_x' | 'ios' | 'macos' | 'tdesktop' | 'weba' | 'webk' | 'unigram' | 'unknown'
...
export type Accelerometer = {
  ...
  y: number
  z: number
  start: (params: AccelerometerStartParams, callback?: (isStarted: boolean) => unknown) => Accelerometer
...
export type DeviceOrientation = {
  ...
  beta: number
  gamma: number
  start: (params: DeviceOrientationStartParams, callback?: (isStarted: boolean) => unknown) => DeviceOrientation
...
export type Gyroscope = {
  ...
  y: number
  z: number
  start: (params: GyroscopeStartParams, callback?: (isStarted: boolean) => unknown) => Gyroscope
...
export type LocationManager = {
  ...
  getLocation: (callback: (data: LocationData | null) => unknown) => LocationManager
...
export type BiometricManager = {
  ...
  updateBiometricToken: (token: string, callback?: (isBiometricTokenUpdated: boolean) => unknown) => BiometricManager
...
export type DeviceStorage = {
  ...
  setItem: (key: string, value: string, callback: (err: unknown, value: unknown) => void) => void
  removeItem: (key: string, callback: (err: unknown, value: unknown) => void) => void
}
...
export interface WebApp {
  ...
  showConfirm: (message: string, callback?: (confirmed: boolean) => unknown) => void
  ...
  checkHomeScreenStatus: (callback?: (status: HomeScreenStatus) => unknown) => void
