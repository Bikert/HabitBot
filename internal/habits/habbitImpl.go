...
func InitHabitService(db *sql.DB) *Service {
	return &Service{
		db: db,
	}
}

func (r *Service) GetHabitByID(id int64) *Habit {
...
func (r *Service) GetDefaultHabits() *[]Habit {
...
func (r *Service) GetHabitsByUserID(userID int64) *[]Habit {
	query := `
...
func (r *Service) Save(habit *Habit) {
...
func (r *Service) SaveHabitByUser(userId int64, habitId int64) {
	_, err := r.db.Exec(
